                ...
                <section class="panel">
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked labels-info ">
                            ...
                            <li> <a href="#"> <i class="fa fa-comments-o text-success"></i> Sanket Ilake<p>I do not think</p></a>  </li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-danger"></i> Ashutosh Utture <p>Busy with coding</p></a> </li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Satyjeet Kondekar <p>I out of control</p></a></li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Tushar Yadav<p>I am not here</p></a></li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Kedar Pdalkar <p>I do not think</p></a>  </li>
                        </ul>
                        <a href="#"> + Add More</a>
