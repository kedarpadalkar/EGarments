			...
			<div class="fh-container mx-auto">
				<div class="row my-lg-5 mb-5">
						...
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							<b>Frocks</b></h2><br><br><br>
						<div class="card-group">
							<!-- card --> 
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-DRESS-04.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro">
										</div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Red Frock</h5>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											...
											<input type="hidden" name="hub_item" value="Red Frock">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-DRESS-01.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Pink Frock</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Pink Frock">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-DRESS-02.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Yellow Frock</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.699</p>
											<p class="line-through">Rs.999</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Yellow Frock">
											<input type="hidden" name="amount" value="699">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-DRESS-03.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Sky Blue Frock</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.699</p>
											<p class="line-through">Rs.999</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Sky Blue Frock">
							...
							<!-- card group  -->
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							<b>Jeans</b></h2><br><br><br>
						<div class="card-group">
							<!-- card --> 
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-JEANS-04.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro">
										</div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Dark Blue Jeans</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.599</p>
											<p class="line-through">Rs.999</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Dark Blue Jeans">
											<input type="hidden" name="amount" value="599">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-JEANS-03.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Plain Jeans</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.699</p>
											<p class="line-through">Rs.999</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Plain Jeans">
											<input type="hidden" name="amount" value="699">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-JEANS-01.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Designer Jeans</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.699</p>
											<p class="line-through">Rs.999</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Designer Jeans">
											<input type="hidden" name="amount" value="699">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-JEANS-02.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
						...
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-PANTS-0001.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Dhoti Pant</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Dhoti Pant">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-PANTS-0002.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Dhoti Pant Printed</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Dhoti Pant Printed">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-PANTS-001.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Three/Four Pant</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.399</p>
											<p class="line-through">Rs.499</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Three/Four Pant">
											<input type="hidden" name="amount" value="399">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/SMALL-GIRLS-PANTS-01.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Three/Four Pant Printed</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.399</p>
											<p class="line-through">Rs.499</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Three/Four Pant Printed">
											<input type="hidden" name="amount" value="399">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
						...
						<!-- card group 3 -->
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							<b>T-Shirt</b></h2><br><br><br>
											<div class="card-group">
							<!-- card -->
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/S G T SHIRT 01.png" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/S G T SHIRT 03.png" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/IMAGE-SMALL-GIRLS-T-SHIRT-000003.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Pink T-Shirt</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.399</p>
											<p class="line-through">Rs.499</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Pink T-Shirt">
											<input type="hidden" name="amount" value="399">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/girls-t-shirt.png" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Red Hoodie</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Red Hoodie">
