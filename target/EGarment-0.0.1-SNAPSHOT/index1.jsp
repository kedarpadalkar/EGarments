				...
				<!--notification start-->
					...
					<div class="notify-w3ls">
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Sanket Ilake</a></span> send you a mail </li>
						...
						<div class="alert alert-danger">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Tushar Yadav</a></span> mentioned you in a post </li>
						...
						<div class="alert alert-success ">
							...
							<div class="notification-info">
								...
								<p>
									<a href="#">Tushar Yadav, Sanket Ilake</a> and <a href="#">3 others</a>
								</p>
							</div>
						</div>
						...
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Ashutosh Utture</a></span> send you a mail </li>
									<li class="pull-right notification-time">1 min ago</li>
								</ul>
								<p>
									Urgent meeting for next proposal
