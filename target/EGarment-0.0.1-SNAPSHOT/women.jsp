			...
			<div class="fh-container mx-auto">
				<div class="row my-lg-5 mb-5">
						...
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							<b>Tops</b></h2><br><br><br>
						<div class="card-group">
							<!-- card -->
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/wto-1.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Tunics Blue</h5>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											...
											<input type="hidden" name="hub_item" value="Tunics Blue">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/wto-2.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Long Tunics</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Long Tunics">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/wto-3.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Half Tunics</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.499</p>
											<p class="line-through">Rs.599</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Half Tunics">
											<input type="hidden" name="amount" value="499">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/wto-4.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Tunics Yellow</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.799</p>
											<p class="line-through">Rs.899</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Tunics Yellow">
											<input type="hidden" name="amount" value="799">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="card-group my-5">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wp-1.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
											<h5 class="card-title text-capitalize">Blue Trouser</h5>
											<div class="card-text d-flex justify-content-between">
												<p class="text-dark font-weight-bold">Rs.999</p>
												<p class="line-through">Rs.1199</p>
											</div>
										</div>
										<!-- card footer -->
										<div class="card-footer d-flex justify-content-end">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="add" value="1">
												<input type="hidden" name="hub_item" value="Blue Trouser">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wp-2.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/wp-3.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Belt Pant</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.799</p>
											<p class="line-through">Rs.899</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Belt Pant">
											<input type="hidden" name="amount" value="799">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<!-- //card -->
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wp-4.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
											...
											<div class="card-text d-flex justify-content-between">
												...
												<p class="line-through">Rs.1699</p>
											</div>
										</div>
										<!-- card footer -->
										<div class="card-footer d-flex justify-content-end">
							...
							<!-- card group 3 -->
						<h2 style="font-family: cursive ; color: dodgerblue; padding-left: 600px;;">
							<b>Sarees</b></h2><br><br><br>
						<div class="card-group">
							<!-- card -->
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/ws-1.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Fancy Border Saree</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.999</p>
											<p class="line-through">Rs.1499</p>
										</div>
									</div>
									<!-- card footer -->
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Fancy Border Saree">
											<input type="hidden" name="amount" value="999">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/ws-2.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Brocade Saree</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.1499</p>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Brocade Saree">
											<input type="hidden" name="amount" value="1499">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="col-lg-3 col-sm-6 p-0">
								...
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/ws-3.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Banarasi Saree</h5>
										<div class="card-text d-flex justify-content-between">
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Banarasi Saree">
							...
							<div class="col-lg-3 col-sm-6 p-0">
								<div class="card product-men p-3">
									<div class="men-thumb-item">
										<img src="images/ws-4.jpg" alt="img" class="card-img-top">
										<div class="men-cart-pro"></div>
									</div>
									<!-- card body -->
									<div class="card-body  py-3 px-2">
										<h5 class="card-title text-capitalize">Silk Saree</h5>
										<div class="card-text d-flex justify-content-between">
											<p class="text-dark font-weight-bold">Rs.999</p>
											<p class="line-through">Rs.1099</p>
										</div>
									...
									<div class="card-footer d-flex justify-content-end">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart">
											<input type="hidden" name="add" value="1">
											<input type="hidden" name="hub_item" value="Silk Saree">
											<input type="hidden" name="amount" value="999">
											<button type="submit" class="hub-cart phub-cart btn">
												<i class="fa fa-cart-plus" aria-hidden="true"></i>
											</button>
							...
							<div class="card-group mt-5">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wtw-1.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
											<h5 class="card-title text-capitalize">Lehenga</h5>
											<div class="card-text d-flex justify-content-between">
												<p class="text-dark font-weight-bold">Rs.4999</p>
												<p class="line-through">Rs.5999</p>
											</div>
										</div>
										<!-- card footer -->
										<div class="card-footer d-flex justify-content-end">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="add" value="1">
												<input type="hidden" name="hub_item" value="Lehenga">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wtw-2.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
											<h5 class="card-title text-capitalize">One Piece</h5>
											<div class="card-text d-flex justify-content-between">
												<p class="text-dark font-weight-bold">Rs.2999</p>
												<p class="line-through">Rs.3999</p>
											</div>
										</div>
										<!-- card footer -->
										<div class="card-footer d-flex justify-content-end">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="add" value="1">
												<input type="hidden" name="hub_item" value="One Piece">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wtw-3.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										<div class="card-body  py-3 px-2">
											<h5 class="card-title text-capitalize">Ethnic Fashion Suit</h5>
											<div class="card-text d-flex justify-content-between">
												<p class="text-dark font-weight-bold">Rs.3999</p>
												<p class="line-through">Rs.4999</p>
											</div>
										</div>
										<!-- card footer -->
										<div class="card-footer d-flex justify-content-end">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="add" value="1">
												<input type="hidden" name="hub_item" value="Ethnic Fashion Suit">
								...
								<div class="col-lg-3 col-sm-6 p-0">
									<div class="card product-men p-3">
										<div class="men-thumb-item">
											<img src="images/wtw-4.jpg" alt="img" class="card-img-top">
											<div class="men-cart-pro"></div>
										</div>
										<!-- card body -->
										1
										<div class="card-body  py-3 px-2">
											<h5 class="card-title text-capitalize">Sharara Suit</h5>
											<div class="card-text d-flex justify-content-between">
												<p class="text-dark font-weight-bold">Rs.3999</p>
												<p class="line-through">Rs.4999</p>
											</div>
										...
										<div class="card-footer d-flex justify-content-end">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="add" value="1">
												<input type="hidden" name="hub_item" value="Sharara Suit">
												<input type="hidden" name="amount" value="4999">
												<button type="submit" class="hub-cart phub-cart btn">
													<i class="fa fa-cart-plus" aria-hidden="true"></i>
												</button>
