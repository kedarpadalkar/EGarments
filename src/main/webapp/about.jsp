                    ...
                    <div id="owl-demo" class="owl-carousel text-center">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">RS2099</p>
                                        <p class="line-through">RS.2299</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        ...
                                        <input type="hidden" name="amount" value="2099">
                                        <button type="submit" class="hub-cart phub-cart btn">
                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>
                                        </button>
                                        <a href="#" data-toggle="modal" data-target="#myModal1"></a>
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        ...
                                        <p class="line-through">RS.1899</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            <div class="product-men p-3 text-center">
                                ...
                                <a href="women.jsp" class="btn btn-lg bg-info text-white">view more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                    <div id="owl-demo1" class="owl-carousel text-center">
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">RS.400</p>
                                        <p class="line-through">RS.599</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        ...
                                        <input type="hidden" name="amount" value="RS.499">
                                        <button type="submit" class="hub-cart phub-cart btn">
                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>
                                        </button>
                                        <a href="#" data-toggle="modal" data-target="#myModal1"></a>
                        ...
                        <div class="item">
                            ...
                            <div class="product-men p-3 text-center">
                                <img src="images/p2.png" class="img-responsive" alt="">
                                <a href="men.jsp" class="btn btn-lg bg-info text-white">view more</a>
                            </div>
                            <!-- //card -->
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="girl" aria-labelledby="girl-tab">
                    <div id="owl-demo2" class="owl-carousel text-center">
                        ...
                        <div class="item">
                            <div class="product-men p-3 text-center">
                                <img src="images/p2.png" class="img-responsive" alt="" />
                                <a href="girls.jsp" class="btn btn-lg bg-info text-white">view more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">
                    <div id="owl-demo3" class="owl-carousel text-center">
                        ...
                        <div class="item">
                            <div class="product-men p-3 text-center">
                                <img src="images/p2.png" class="img-responsive" alt="" />
                                <a href="boys.jsp" class="btn btn-lg bg-info text-white">view more</a>
                            </div>
                        </div>
                    </div>
                </div>
